...
// Notice instantiations
TF_INSTANTIATE_TYPE(EditorDrawMainMenuBarNotice, TfType::CONCRETE, TF_1_PARENT(TfNotice));
...
void Editor::DrawMainMenuBar() {
    ...
    if (ImGui::BeginMainMenuBar()) {
        ...
        EditorDrawMainMenuBarNotice{this}.Send();
...
void Editor::Draw() {
    ...
    EditorDrawTopLevelNotice{this}.Send();
